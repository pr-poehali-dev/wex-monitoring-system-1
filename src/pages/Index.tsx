...
const MOCK_SERVERS = [
  {
    id: 1,
    name: "CrafteriaWorld",
    ip: "play.crafteriaworld.ru",
    description: "Лучший выживальный сервер с экономикой, кланами и PvP-ареной. Уже 5 лет в топе!",
    version: "1.20",
    online: 1247,
    maxOnline: 2000,
    votes: 8432,
    ...
    telegram: "https://t.me",
    website: "https://crafteriaworld.ru",
    image: "https://images.unsplash.com/photo-1542751371-adc38448a05e?w=400&h=200&fit=crop",
    rank: 1,
    premium: true,
    tags: ["PvP", "Экономика", "Кланы"],
  },
  {
    id: 2,
    name: "SkyBlock Pro",
    ip: "skyblock.pro-mc.ru",
    description: "Классический SkyBlock с квестами, боссами и уникальными островами.",
    version: "1.19",
    online: 834,
    maxOnline: 1500,
    votes: 6211,
    ...
    rank: 2,
    premium: true,
    tags: ["SkyBlock", "Квесты", "Боссы"],
  },
  {
    id: 3,
    name: "HungerCraft",
    ip: "hungercraft.net",
    description: "Игры на выживание, Hunger Games и мини-игры для любителей PvP.",
    version: "1.16",
    online: 521,
    maxOnline: 1000,
    votes: 4109,
    ...
    discord: "https://discord.gg",
    telegram: "https://t.me",
    website: "https://hungercraft.net",
    image: "https://images.unsplash.com/photo-1511512578047-dfb367046420?w=400&h=200&fit=crop",
    rank: 3,
    premium: false,
    tags: ["HungerGames", "PvP", "Мини-игры"],
  },
  {
    id: 4,
    name: "MagicRPG",
    ip: "magic-rpg.ru",
    description: "РПГ сервер с уникальными классами, магией и огромным открытым миром.",
    version: "1.20",
    online: 389,
    maxOnline: 800,
    votes: 3876,
    ...
    discord: "https://discord.gg",
    telegram: null,
    website: "https://magic-rpg.ru",
    image: "https://images.unsplash.com/photo-1493711662062-fa541adb3fc8?w=400&h=200&fit=crop",
    rank: 4,
    premium: false,
    tags: ["RPG", "Магия", "Классы"],
  },
  {
    id: 5,
    name: "AnarchiaMC",
    ip: "anarchia.fun",
    description: "Анархия без правил. Для настоящих хардкорных игроков.",
    version: "1.12",
    online: 278,
    maxOnline: 500,
    votes: 2543,
    ...
    rank: 5,
    premium: false,
    tags: ["Анархия", "Хардкор"],
  },
  {
    id: 6,
    name: "BuildCraft Universe",
    ip: "buildcraft.universe",
    description: "Строй без ограничений. Огромные творческие миры и конкурсы построек.",
    version: "1.21",
    online: 445,
    maxOnline: 1000,
    votes: 3201,
    ...
    discord: "https://discord.gg",
    telegram: "https://t.me",
    website: "https://buildcraft.universe",
    image: "https://images.unsplash.com/photo-1468276311594-df7cb65d8df6?w=400&h=200&fit=crop",
    rank: 6,
    premium: false,
    tags: ["Творческий", "Конкурсы", "Строительство"],
  },
];
